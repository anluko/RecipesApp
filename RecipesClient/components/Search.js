...
export default function Search({ navigation }) {
  ...
  useEffect(() => {
    axios
      .get("http://192.168.1.7:8080/linked/cuisineTypes")
      .then((response) => {
    ...
    axios
      .get("http://192.168.1.7:8080/linked/dishTypes")
      .then((response) => {
    ...
    axios
      .get("http://192.168.1.7:8080/linked/mealTypes")
      .then((response) => {
    ...
    axios
      .get("http://192.168.1.7:8080/recipes")
      .then((response) => {
          ...
          {filterVisibility && (
            <View style={styles.filterElementsView}>
              <MultipleSelectList
                ...
                defaultOption={cuisineSelected.map((option) => ({
                  key: option.key,
                  value: option.value,
                }))}
                label="Тип кухни"
